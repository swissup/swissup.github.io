---
layout: default
title: Geo Address IP Changelog
...
> August 21, 2025
 ...
 -  Added ability to enable daily [automatic MaxMind Database updates](/m2/extensions/geo-address-ip/configuration/)
...
> May 8, 2020
 ...
 -  You can now [download and update](/m2/extensions/geo-address-ip/configuration/) MaxMind
    database in just one click.

    > Database is now stored in `<magento_root>/var/swissup/geoip/maxmind.mmdb` file.
    >
    > In order to keep Geo Address IP functionality working for our existing customers,
...
> Jun 4, 2019
 ...
 -  Two new [data providers](/m2/extensions/geo-address-ip/configuration/) added:
