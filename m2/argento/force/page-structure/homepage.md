        ...
        <div class="block block-carousel">
            ...
            <div class="block-content">
                <div class="slick-slider" data-mage-init='{"slick": {"slidesToShow": 6, "slidesToScroll": 1, "dots": false, "autoplay": true, "swipeToSlide": true, "rows": 0, "lazyLoad": "ondemand"}}'>
                    <div><a href="#"><img data-lazy="{{view url='images/brands/puma.png'}}" alt="" width="120" height="80"/></a></div>
                    <div><a href="#"><img data-lazy="{{view url='images/brands/nike.png'}}" alt="" width="120" height="80"/></a></div>
                    <div><a href="#"><img data-lazy="{{view url='images/brands/adidas.jpg'}}" alt="" width="120" height="80"/></a></div>
                    <div><a href="#"><img data-lazy="{{view url='images/brands/under-armour.jpg'}}" alt="" width="120" height="90"/></a></div>
                    <div><a href="#"><img data-lazy="{{view url='images/brands/puma.png'}}" alt="" width="120" height="80"/></a></div>
                    <div><a href="#"><img data-lazy="{{view url='images/brands/nike.png'}}" alt="" width="120" height="80"/></a></div>
                    <div><a href="#"><img data-lazy="{{view url='images/brands/adidas.jpg'}}" alt="" width="120" height="80"/></a></div>
                    <div><a href="#"><img data-lazy="{{view url='images/brands/under-armour.jpg'}}" alt="" width="120" height="90"/></a></div>
