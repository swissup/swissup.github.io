...
Magento quick view module comes with extended configuration. You can set the display of different content (link) in quick view popup, change the product listing settings (link) and configure the product page (link).
